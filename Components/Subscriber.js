...
function Subscribe() {
  return (
    <>
      <div className="md:hidden md:subscribe-box flex border-solid border-2 bg-transparent border-teal-500 rounded-md lg:w-11/12 h-24 mt-10 lg:ml-14 mb-10">
        ...
        <div className="border-solid border-2 bg-transparent font-open text-normal text-sm text-slate-400 border-slate-200 w-32 md:ml-0 lg:w-80 h-12 lg:ml-36 lg:mt-4">
          E-Mail Address
        </div>
        <div>
