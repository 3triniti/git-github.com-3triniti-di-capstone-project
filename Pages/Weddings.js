          ...
          <div className="grid-cols-1 md:flex pt-4 mb-8">
            ...
            <div>
              ...
              <p className="font-open font-thin text-lg text-black text-left ml-12 md:ml-12 mr-10 md:mr-12 mb-10 md:mb-3">
                ...
                ceremonies also known as “Chanoyu”, much like the Chinese in
                conception, are more quiet and serene. They are meant to
                symbolize harmony, purity and respect between both parties. It
                is the Way of Tea. The guests sit in revered silence while the
                hosts prepare the sacred tea and delicately discuss the tea and
                its preparation while they sip it.
              </p>
